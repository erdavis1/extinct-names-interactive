<script>
  ...
  // Make sure we are focused when opening/toggling via the container
  // (clicking the indicators doesn't necessarily focus the input)
  ...
  listOpen = !listOpen;
    ...
    function setListWidth() {
        ...
        if (listAutoWidth) {
            // anchor width is the minimum; let content grow wider
            list.style.minWidth = width + 'px';
            list.style.width = 'max-content';
            // optional safety so it doesn't become ridiculous
            list.style.maxWidth = 'min(90vw, 48rem)';
        } else {
            list.style.minWidth = '';
...
<style>
    .svelte-select {
        ...
        --internal-padding: 0 0 0 0px;

        border: var(--border, 0px solid #D6D0C4);
      
        border-radius: var(--border-radius, 3px);
        min-height: var(--height, 28px);
        position: relative;
        display: flex;
    ...
    * {
    ...
    .svelte-select:hover {
        border: var(--border-hover, 0px solid #4a4645);
    }
    ...
    .value-container {
        ...
        position: relative;
        overflow: var(--value-container-overflow, visible);
        align-self: stretch;
    }
    ...
    input::placeholder {
        color: var(--placeholder-color, #4a4645);
    ...
    .svelte-select.focused {
        border: var(--border-focused, 0px solid #4a4645);
    ...
    .selected-item {
        position: relative;
        overflow: var(--selected-item-overflow, visible);
        padding: var(--selected-item-padding, 0 0px 0 0);
    ...
    .chevron {
        width: var(--chevron-width, 28px);
        height: var(--chevron-height, 28px);
